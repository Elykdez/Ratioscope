...
namespace ShaderlabVSCode
{
    ...
    public class ShaderlabVSCodeEditor
    {
        ...
        static string[] SHADER_FILE_EXTENSIONS { get; } = new string[] {
            ".shader",
            ".compute",
            ".cginc",
            ".glslinc",
        ...
        private static List<DataPair> DATA_PAIRS { get; } = new List<DataPair>()
        {
...
#else
            return Path.Combine(Path.Combine(Application.dataPath, "ShaderlabVSCode"), "ScriptTemplates");
#endif
        }
...
#else
            return Path.Combine(Path.Combine(contentsPath, "Resources"), "ScriptTemplates");
#endif
        }
        #endregion
    }
