...
namespace Hypocycloid.Utils
{
    public static class StringBuilderExtensions
    {
        ...
        public static StringBuilder ReplaceFirst(
        ...
        public static StringBuilder ReplaceFirst(
            ...
            string search,
            string replace,
            out int indexOfReplacementStart,
            int startIndex = 0
        )
        {
        ...
        public static StringBuilder InsertChain(
            this StringBuilder builder,
            int index,
            out int insertionEndIndex,
        ...
        public static StringBuilder PrependChain(
            this StringBuilder builder,
            out int insertionEndIndex,
            IEnumerable<string> elements
        ...
        public static bool IsNotEmpty(this StringBuilder builder) => builder.Length > 0;
