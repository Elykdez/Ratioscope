...
namespace Hypocycloid.Utils
{
    public static class NumberExtensions
    {
        ...
        public static float ToThePowerOf(this float @base, float exponent) => Mathf.Pow(@base, exponent);
        ...
        public static int CeilingToInt(this float value) => Mathf.CeilToInt(value);
        ...
        public static int FloorToInt(this double value) => (int)value.Floor();

        public static int CeilingToInt(this double value) => (int)value.Ceiling();
        ...
        public static float InvertIf(this float value, bool condition) => condition ? -value : value;
    }
}
