...
namespace Hypocycloid.UI
{
    ...
    public static class Markdown
    {
        ...
        public static void RenderToTextMesh(
            string markdownSource,
            TMP_Text textMesh,
            MarkdownRenderingSettings settings,
            params ICustomTextPreProcessor[] customTextPreProcessors
        )
        {
        ...
        public static void UpdateTextMesh(TMP_Text textMesh)
        {
            ...
            textMesh.GetComponent<UITextHyperlink>()?.LinkDataUpdated();
        ...
        public static string MarkdownToRichText(
            string source,
            MarkdownRenderingSettings settings,
            params ICustomTextPreProcessor[] customTextPreProcessors
        )
        {
            ...
            using (var reader = new StringReader(source))
            {
                ...
                {
                    lines.Add(new MarkdownLine() { Builder = new StringBuilder(line) });
                }
            }
        ...
        static readonly IReadOnlyList<MarkdownLineProcessorBase> BuiltInLineProcessors =
            new MarkdownLineProcessorBase[]
            {
